...
executable	= tests/runme_dqcd_scenarioB1_2024_deploy_signal_HalfSamples.sh
arguments	= "$(PROCESS) $(NJobs)"
output		= iceqsub/output/outputfile.$(CLUSTER)
error		= iceqsub/error/errorfile.$(CLUSTER)
log		= iceqsub/log/dqcd_scenarioB1_deploy_2024_signal_HalfSamples.job.$(CLUSTER).log
