executable	= tests/runme_dqcd_scenarioB1_2024_DoubleMu_train_HalfSamples.sh
output		= iceqsub/output/outputfile.$(CLUSTER)
error		= iceqsub/error/errorfile.$(CLUSTER)
log		= iceqsub/log/dqcd_scenarioB1_train_2024_DoubleMu_HalfSamples.job.$(CLUSTER).log
