...
CONFIG="tune0_2024_Mu10_withMET_new.yml"
DATAPATH="/vols/cms/khl216"

CONDITIONAL=0


MODELTAG="scenarioA_all_no_DA_old_BDT_with_dRmSV_2024_Mu10_withMET"
#MODELTAG="scenarioA_all_no_DA_old_BDT_with_dRmSV_2024_Mu10_withMET_v2"   #adding muonSV_delta_phi_MET
