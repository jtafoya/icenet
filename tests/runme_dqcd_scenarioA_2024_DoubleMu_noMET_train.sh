...
python analysis/dqcd_2024.py --runmode train    --maxevents $MAX --inputmap mc_map__scenarioA_all_2024.yml --modeltag scenarioA_all_no_DA_old_BDT_with_dRmSV_2024_DoubleMu_noMET --config $CONFIG --datapath $DATAPATH --use_conditional $CONDITIONAL
python analysis/dqcd_2024.py --runmode eval     --maxevents $MAX --inputmap mc_map__scenarioA_all_2024.yml --modeltag scenarioA_all_no_DA_old_BDT_with_dRmSV_2024_DoubleMu_noMET --config $CONFIG --datapath $DATAPATH --use_conditional $CONDITIONAL
python analysis/dqcd_2024.py --runmode optimize --maxevents $MAX --inputmap mc_map__scenarioA_all_2024.yml --modeltag scenarioA_all_no_DA_old_BDT_with_dRmSV_2024_DoubleMu_noMET --config $CONFIG --datapath $DATAPATH --use_conditional $CONDITIONAL
