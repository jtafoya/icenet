...
python analysis/dqcd.py --runmode train    --maxevents $MAX --inputmap mc_map__scenarioA_all.yml --modeltag scenarioA_all_no_DA_old_BDT_with_dRmSV_2018_firstTry --config $CONFIG --datapath $DATAPATH --use_conditional $CONDITIONAL
python analysis/dqcd.py --runmode eval     --maxevents $MAX --inputmap mc_map__scenarioA_all.yml --modeltag scenarioA_all_no_DA_old_BDT_with_dRmSV_2018_firstTry --config $CONFIG --datapath $DATAPATH --use_conditional $CONDITIONAL
python analysis/dqcd.py --runmode optimize --maxevents $MAX --inputmap mc_map__scenarioA_all.yml --modeltag scenarioA_all_no_DA_old_BDT_with_dRmSV_2018_firstTry --config $CONFIG --datapath $DATAPATH --use_conditional $CONDITIONAL
